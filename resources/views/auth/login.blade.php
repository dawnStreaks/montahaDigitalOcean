...
<head>
    ...
    <title>MONTAHA ALAJEEL | Login </title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Hi, please sign in</p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group has-feedback">
                <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email" value="{{ old('email') }}" autofocus required autocomplete="off">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary btn-block btn-lg" style="background-color: #000; padding-bottom:5%;padding-top:5%; ">Sign In</button>
                </div>
                <!-- /.col -->
            </div>
